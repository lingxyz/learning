...
* [徒手撸一个Ajax✍](javascript/ajax-plugin.md)
...
* [用Docker统一本地开发环境](engineering/unified-development-environment.md)
* [如何快速进行前后端分离?✍](engineering/fe-be-separation.md)
* [系统解耦的几种方式✍](engineering/system-decoupling.md)

## 项目管理 <a id="pm"></a>

* [从需求承接到代码交付程序员都经历了什么？✍](pm/coder-workflow.md)

## 团队管理 <a id="tm"></a>

* [构建游戏化组织](tm/game-team.md)
* [细节和格局的矛盾冲突✍](tm/details_vs_pattern.md)
